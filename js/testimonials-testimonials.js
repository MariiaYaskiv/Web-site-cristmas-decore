(function() {
    const slides = [
        ...
        `<div class = "testimonials-first-image"> <div> <img src = "img/testimonials-testimonials/happy-family-with-present.jpg" alt = "# "/> </div> <div> <h5> Dean and Alice Peterson </h5> </div> <div> <p>"Christmas is a spacial time! We always buy Christmas Decorations in advance. For the third year now? we have been making orders in this store and are completely satisfied with the quality of each bauble purchased " </p> </div> <div class = "testimonials-text-curved "> <i> December 15, 2019 </i> </div> </div>`,
        `<div class="testimonials-second-image-right"> <div> <img src="img/testimonials-testimonials/marry-christmas.jpg" alt="# "/> </div> <div> <h5> Susan Owler </h5> </div> <div> <p> "My daughter is four years old and she has been waiting for Christmas preparation since October! We start decorating the Christmas tree in early December, and I always buy something new at Christmas Decorations shop." </p> </div> <div class="testimonials-text-curved"> <i> December 08, 2018 </i> </div> </div>`,
        `<div class="testimonials-right-two"> <div> <img src="img/testimonials-testimonials/happy-family-one.jpg" alt="# "/> </div> <div> <h5> Daniella Lencingtone </h5> </div> <div> <p> "The anticipation of Christmas is the best thing in December. I like the feeling that magic is coming and try to start Christmas decorations in early December. This year, I have bought a new X-mas tree and lots of baubles." </p> </div> <div class="testimonials-text-curved "> <i> December 02, 2020 </i> </div> </div>`
    ];
